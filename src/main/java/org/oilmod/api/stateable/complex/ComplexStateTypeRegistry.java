...
public class ComplexStateTypeRegistry extends RegistryBase<IComplexStateType<?>, ComplexStateTypeRegistry, ComplexStateTypeRegistry.RegistryMPI, ComplexStateTypeRegistry.RegistryHelper<?>> {
    ...
    public static final class RegistryMPI extends SimpleRegistryMPIBase<IComplexStateType<?>, ComplexStateTypeRegistry, RegistryMPI, RegistryHelper<?>> {
        @Override
    ...
    public static abstract class RegistryHelper<Impl extends RegistryHelper<Impl>> extends RegistryHelperBase<IComplexStateType<?>, ComplexStateTypeRegistry, RegistryMPI, RegistryHelper<?>, Impl> {
        @Override
